...
def init_slope(shape):
    return theano.shared(floatX(0.25 + np.zeros(shape)))
...
s_h = init_slope((60000,625))
s_h2 = init_slope((60000,625))

noise_h, noise_h2, noise_py_x = model(X, w_h, w_h2, s_h, s_h2, w_o, 0.8, 0.5)
h, h2, py_x = model(X, w_h, w_h2, s_h, s_h2, w_o, 1., 1.)
